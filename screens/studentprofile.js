...
const reviewSchema = yup.object({
  ...
  roll: yup.string().required().min(1).max(50),
});
        ...
        <View style={workSheetStyle.content}>
                ...
                <Formik 
                    ...
                    onSubmit={ async (val, actions) => {
                          ...
                          setLoader(false);
                          nav.navigate("ClassWiseStudentsList", {class: params.item.class, section: params.item.section});
                }}>
                    {(props) =>(
                        <View>
                            ...
                            <Text style={loginRegisterStyle.text}>Admission Date </Text>
                            <TextInput 
